...
from novel_engine.data.quiz_data import AIQuizFallbackModel, QuizContentModel, QuizDatabase
...
def test_quiz_database_returns_pydantic_union() -> None:
    result = QuizDatabase.get_quiz("化学", "必修一 1.1 物质的分类与转化")
    assert isinstance(result, (QuizContentModel, AIQuizFallbackModel))
